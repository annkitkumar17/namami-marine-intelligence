...
export const INITIAL_PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    ...
    status: 'CONNECTED',
    enabled: true,
    apiKey: '4488e52b16-cd68-4ec5-b2f7-0469e5c91b69',
    endpointUrl: 'https://dhruva-api.bhashini.gov.in/services/inference',
    lastSync: 'Just now',
    freshnessMins: 0,
    notes: 'Authenticated with Udyat Key & Inference Token. Live ASR, IndicTrans2 (10+ Languages) and TTS active.',
  },
  {
    id: 'open-meteo',
